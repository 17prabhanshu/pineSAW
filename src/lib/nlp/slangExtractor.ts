...
export class DarknetNLPExtractor {
  ...
  private static readonly SLANG_DICTIONARY: Record<string, { std: string; cat: ExtractedNarcoticsEntity["substanceClass"] }> = {
    ...
    "black tar": { std: "Heroin (Black Tar)", cat: "SYNTHETIC_OPIOID" },
    ...
    "molly": { std: "MDMA (Crystal/Powder)", cat: "STIMULANT" },
    "ecstasy": { std: "MDMA (Pill form)", cat: "STIMULANT" },
    ...
    "ket": { std: "Ketamine HCL", cat: "DISSOCIATIVE" },
    ...
    "percocet": { std: "Oxycodone/Paracetamol", cat: "SYNTHETIC_OPIOID" },
    "percs": { std: "Oxycodone/Paracetamol", cat: "SYNTHETIC_OPIOID" },
    ...
    "kush": { std: "Cannabis Flower", cat: "CANNABINOID" },
  };
