    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-zinc-950 border border-white/20 rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden font-mono"
        >
          {/* Header */}
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 text-xs text-zinc-200 bg-black/40 print:bg-white print:text-black print:p-0">
            {/* Judicial Title Heading */}
            <div className="text-center space-y-1.5 border-b border-white/15 pb-5 print:border-black">
              <div className="text-[11px] font-bold tracking-widest text-zinc-400 print:text-gray-700 uppercase">
              ...
              <h2 className="text-xs font-semibold text-zinc-300 print:text-gray-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-zinc-900/80 p-3.5 rounded-xl border border-white/10 print:border print:border-black print:bg-gray-50 text-[10px]">
              <div>
                <span className="text-zinc-500 uppercase block">Certificate Ref</span>
                <span className="text-white print:text-black font-bold truncate block">{certificate.certificateId}</span>
              </div>
              <div>
                <span className="text-zinc-500 uppercase block">Case Reference</span>
                <span className="text-white print:text-black font-bold block">{certificate.caseRef}</span>
              </div>
              <div>
                <span className="text-zinc-500 uppercase block">Exhibit ID</span>
                <span className="text-emerald-400 print:text-black font-bold block">{certificate.exhibitId}</span>
              </div>
              <div>
                <span className="text-zinc-500 uppercase block">Certified Date</span>
            ...
            <div className="border border-white/15 rounded-xl p-4 bg-black/60 print:bg-white print:border-black space-y-2.5">
              ...
              <div className="space-y-1.5 font-mono text-[10px]">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/5 pb-1">
                  <span className="text-zinc-400 print:text-gray-600">SHA-256 Checksum:</span>
                  <span className="text-emerald-400 print:text-black font-bold break-all select-all">
                    {certificate.technicalProfile.sha256Digest}
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/5 pb-1">
                  <span className="text-zinc-400 print:text-gray-600">MD5 Message Digest:</span>
                  <span className="text-zinc-300 print:text-black font-bold break-all select-all">
                    {certificate.technicalProfile.md5Digest}
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/5 pb-1">
                  <span className="text-zinc-400 print:text-gray-600">RFC 3161 Timestamp Seal:</span>
                  <span className="text-amber-300 print:text-black font-bold">
                    {certificate.technicalProfile.rfc3161TimestampSeal}
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/5 pb-1">
                  <span className="text-zinc-400 print:text-gray-600">Acquisition Workstation:</span>
                  <span className="text-white print:text-black font-bold">
                    {certificate.technicalProfile.workstationHost}
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                  <span className="text-zinc-400 print:text-gray-600">Forensic Software Kernel:</span>
                  <span className="text-white print:text-black font-bold">
            ...
            <div className="border border-white/10 rounded-xl p-5 bg-black/80 print:bg-white print:border-black text-[11px] leading-relaxed text-zinc-300 print:text-black whitespace-pre-wrap font-mono">
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="p-3 border border-emerald-500/30 rounded-xl bg-emerald-950/40 text-emerald-400 print:border-black print:text-black">
                  <ShieldCheck size={28} weight="fill" />
                </div>
                <div>
                  <div className="text-[10px] uppercase font-bold text-zinc-400 print:text-gray-600">Verification Seal</div>
                  <div className="text-xs font-bold text-white print:text-black">ZERO TAMPER DETECTED · CRYPTOGRAPHIC MATCH</div>
                  <div className="text-[10px] text-zinc-500 print:text-gray-600">Compliant with Supreme Court Arjun Panditrao (2020) Mandate</div>
                </div>
              </div>

              <div className="text-right border-t sm:border-t-0 border-white/10 pt-2 sm:pt-0">
                ...
                <div className="text-[10px] text-zinc-500 print:text-gray-600">Badge ID: {certificate.deponent.badgeNumber} · {certificate.deponent.station}</div>
              </div>
            </div>
          </div>
        </motion.div>
